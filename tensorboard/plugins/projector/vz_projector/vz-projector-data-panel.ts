  ...
  export class DataPanel extends DataPanelPolymer {
    ...
    metadataChanged(
      ...
      if (
        ...
        this.metadataEditorColumn = this.metadataFields[
    ...
    private metadataEditorContext(enabled: boolean) {
      ...
      if (this.projector) {
        this.projector.metadataEditorContext(
          enabled,
          this.metadataEditorColumn
        );
      }
    }
    ...
    private setupUploadButtons() {
      ...
      if (this.projector.servingMode !== 'demo') {
        ...
        (this.$$(
          '#upload-tensors-step-container'
        ) as HTMLElement).style.display = 'none';
        (this.$$('#upload-metadata-label') as HTMLElement).style.display =
          'none';
      }
